...
public class TangoARScreen : MonoBehaviour
{
    ...
    private float eyelidPosition = 0.5f;
    ...
    private void _SetScreenVertices(float normalizedOffsetX, float normalizedOffsetY)
    {
        ...
        //StartCoroutine("EyelidMovement");
        verts[0] = new Vector3(-1.0f - normalizedOffsetX, -eyelidPosition - normalizedOffsetY, 1.0f);
        verts[1] = new Vector3(-1.0f - normalizedOffsetX, eyelidPosition + normalizedOffsetY, 1.0f);
        verts[2] = new Vector3(1.0f + normalizedOffsetX, eyelidPosition + normalizedOffsetY, 1.0f);
        verts[3] = new Vector3(1.0f + normalizedOffsetX, -eyelidPosition - normalizedOffsetY, 1.0f);
